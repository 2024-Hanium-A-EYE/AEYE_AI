...
from tensorflow.keras.layers import Input, Multiply, GlobalAveragePooling2D, Add, Dense, Activation, Maximum, ZeroPadding2D, BatchNormalization, Flatten, Conv2D, AveragePooling2D, MaxPooling2D, GlobalMaxPooling2D, Lambda, UpSampling2D, DepthwiseConv2D, SeparableConv2D
...
def RDBI(X, filters, base, number):
    ...
    return X
def aeye_OpticNet(input_size,num_of_classes):
