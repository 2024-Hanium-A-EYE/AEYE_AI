            ...
            if file_name:
                if file_size:
                    if file_hash:
                        ...
                        print_log('active', whoami, api, "{} missed to send file_hash. recieved : {}".format(whoami, request.data))
                        whoami ='AEYE OpticNet API UCTC'
                    ...
                    print_log('error', whoami, api, "{} missed to send file_size. recieved : {}".format(whoami, request.data))
                    whoami ='AEYE OpticNet API UCTC'
                ...
                print_log('error', whoami, api, "{} missed to send file_name. recieved : {}".format(whoami, request.data))
                whoami ='AEYE OpticNet API UCTC'
